...
(
    ...
    CONSTRAINT pk_text_id UNIQUE (text, commenter_id)
);

CREATE TABLE IF NOT EXISTS comment_blames
(
    id         BIGINT GENERATED BY DEFAULT AS IDENTITY,
    user_id    BIGINT REFERENCES users (id) ON DELETE CASCADE,
    comment_id BIGINT REFERENCES comments (id) ON DELETE CASCADE,
    CONSTRAINT pk_blame_id PRIMARY KEY (id),
    CONSTRAINT pk_blame_user_id UNIQUE (user_id, comment_id)
);
